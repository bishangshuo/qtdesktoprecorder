...
QT_MOC_LITERAL(1, 14, 16), // "sigCaptureScreen"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 6), // "pixmap"
QT_MOC_LITERAL(4, 39, 9) // "timestamp"

    },
    "CaptureScreen\0sigCaptureScreen\0\0pixmap\0"
    "timestamp"
};
...
void CaptureScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigCaptureScreen((*reinterpret_cast< const QPixmap(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureScreen::*)(const QPixmap & , qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureScreen::sigCaptureScreen)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureScreen::sigCaptureScreen(const QPixmap & _t1, qint64 _t2)
{
